...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_QWERTY] = LAYOUT(
      KC_ESC,   FR_Q,    FR_W,    KC_F,     KC_P,   KC_B,           KC_J,     KC_L,   KC_U,       KC_Y,       FR_EACU,    KC_BSPC,
      KC_TAB,   FR_A,    KC_R,    KC_S,     KC_T,   KC_G,           KC_H,     KC_N,   KC_E,       KC_I,       KC_O,       KC_ENT,
      KC_LSFT,  FR_Z,    KC_X,    KC_C,     KC_D,   KC_V,           KC_K,     FR_M,   FR_COMM,    FR_DOT,     KC_UP,      FR_SCLN,
      FR_A,     KC_LCTL, KC_LALT, KC_LGUI,  LOWER,  QK_BOOT,        KC_SPC,   RAISE,  KC_DELETE,  KC_LEFT,    KC_DOWN,    KC_RGHT
    ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
